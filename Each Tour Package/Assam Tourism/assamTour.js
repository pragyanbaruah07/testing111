...
let neHorPack1 = document.getElementById("neHorizonAsP1");
let neHorPack2 = document.getElementById("neHorizonAsP2");
let neHorPack3 = document.getElementById("neHorizonAsP3");
let neHorPack4 = document.getElementById("neHorizonAsP4");
let neHorPack5 = document.getElementById("neHorizonAsP5");
let neHorPack6 = document.getElementById("neHorizonAsP6");

//Each package Selection Card (Div Element)
let neHorpackCard1 = document.getElementById("neHorizonTourAsT1");
let neHorpackCard2 = document.getElementById("neHorizonTourAsT2");
let neHorpackCard3 = document.getElementById("neHorizonTourAsT3");
let neHorpackCard4 = document.getElementById("neHorizonTourAsT4");
let neHorpackCard5 = document.getElementById("neHorizonTourAsT5");
let neHorpackCard6 = document.getElementById("neHorizonTourAsT6");
