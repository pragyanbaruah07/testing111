...
let neHorPack1 = document.getElementById("neHorizonSiP1");
let neHorPack2 = document.getElementById("neHorizonSiP2");
let neHorPack3 = document.getElementById("neHorizonSiP3");
let neHorPack4 = document.getElementById("neHorizonSiP4");
let neHorPack5 = document.getElementById("neHorizonSiP5");
let neHorPack6 = document.getElementById("neHorizonSiP6");

//Each package Selection Card (Div Element)
let neHorpackCard1 = document.getElementById("neHorizonTourSiT1");
let neHorpackCard2 = document.getElementById("neHorizonTourSiT2");
let neHorpackCard3 = document.getElementById("neHorizonTourSiT3");
let neHorpackCard4 = document.getElementById("neHorizonTourSiT4");
let neHorpackCard5 = document.getElementById("neHorizonTourSiT5");
let neHorpackCard6 = document.getElementById("neHorizonTourSiT6");
