...
let neHorPack1 = document.getElementById("neHorizonMaP1");
let neHorPack2 = document.getElementById("neHorizonMaP2");
let neHorPack3 = document.getElementById("neHorizonMaP3");
let neHorPack4 = document.getElementById("neHorizonMaP4");
let neHorPack5 = document.getElementById("neHorizonMaP5");
let neHorPack6 = document.getElementById("neHorizonMaP6");

//Each package Selection Card (Div Element)
let neHorpackCard1 = document.getElementById("neHorizonTourMaT1");
let neHorpackCard2 = document.getElementById("neHorizonTourMaT2");
let neHorpackCard3 = document.getElementById("neHorizonTourMaT3");
let neHorpackCard4 = document.getElementById("neHorizonTourMaT4");
let neHorpackCard5 = document.getElementById("neHorizonTourMaT5");
let neHorpackCard6 = document.getElementById("neHorizonTourMaT6");
