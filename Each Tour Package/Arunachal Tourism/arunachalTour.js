...
let neHorPack1 = document.getElementById("neHorizonArP1");
let neHorPack2 = document.getElementById("neHorizonArP2");
let neHorPack3 = document.getElementById("neHorizonArP3");
let neHorPack4 = document.getElementById("neHorizonArP4");
let neHorPack5 = document.getElementById("neHorizonArP5");
let neHorPack6 = document.getElementById("neHorizonArP6");

//Each package Selection Card (Div Element)
let neHorpackCard1 = document.getElementById("neHorizonTourArT1");
let neHorpackCard2 = document.getElementById("neHorizonTourArT2");
let neHorpackCard3 = document.getElementById("neHorizonTourArT3");
let neHorpackCard4 = document.getElementById("neHorizonTourArT4");
let neHorpackCard5 = document.getElementById("neHorizonTourArT5");
let neHorpackCard6 = document.getElementById("neHorizonTourArT6");
